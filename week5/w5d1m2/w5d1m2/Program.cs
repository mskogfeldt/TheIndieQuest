...
namespace w5d1m2
{
    class Program
    {
        ...
        {
            int[] data = { 2, 1, 14, 7, 3, 12, 10, 15, 4, 2, 9, 11, 5, 8, 6, 13 };
            ...
            void SortArray(int[] someUnsortedList)
            {
                if (someUnsortedList.Length == 0) return;
                ...
                } while (sortedCount < someUnsortedList.Length);
